        ...
        <div class="report-shell">
            ...
            @else
                <div class="report-kpis">
                    <article class="report-panel report-kpi">
                    ...
                    <div class="table-wrap">
                        <table class="report-table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2">No accommodation applications found for this year.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @forelse ($applications as $application)
                                    <tr>
                                        ...
                                        <td>{{ $application->faculty ?: 'Not recorded' }}</td>
                                        <td>{{ $application->programme ?: 'Not recorded' }}</td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8">No accommodation applications found for this year.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                        ...
                        <table class="report-table">
                            ...
                            <tbody>
                                @forelse ($rooms as $room)
                                    <tr>
                                        <td>{{ $room->block_name }}-{{ str_pad((string) $room->room_number, 2, '0', STR_PAD_LEFT) }}</td>
                                        <td>{{ $room->capacity }}</td>
                                        <td>{{ $room->occupied_beds }}</td>
                                        <td>{{ max(0, $room->capacity - $room->occupied_beds) }}</td>
                                        <td>{{ $room->occupied_beds < $room->capacity ? 'Available' : 'Full' }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5">No rooms available in the system.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
